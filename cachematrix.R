...
## makeCachedMatrix take an matrix and precalculate the inverted matrix for later use.
## input is a matrix
...
## cacheSolve takes in the input from the vector created by makeCacheMatrix and calculate the invert matrix.
